...
# linha representa uma linha da tabela e as colunas são separadas por vírguulas.
# Ele é amplamente utilizado para transferir dados entre sistemas de diferentes
# plataformas, como por exemplo, para importar ou exportar dados para uma planilha 
# (Google Sheets, Excel, LibreOffice Calc) ou para uma base de dados. 
# Um arquivo CSV geralmente tem a extensão ".csv" e pode ser aberto em um 
# editor de texto ou planilha eletrônica 
# Um exemplo de um arquivo CSV pode ser:
# Nome, Idade, Endereço 
# Luiz Otávio, 32, "Av Brasil, 21, Centro"
# João da Silva. 55, "Rua 22, 44, Nova Era"
# A primeira linha do arquivo define os nomes das colunas da, enquanto 
